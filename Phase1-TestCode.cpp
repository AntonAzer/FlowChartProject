...
int main()
{
	...
	P.x = 100;	P.y = 100;
	pOut->DrawAssign(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "x = 5", true);
	P.x = 300;	P.y = 300;
	pOut->DrawAssign(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "y = 6", false);
	P.x = 600;	P.y = 300;
	pOut->DrawAssign(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "x = 7", true);
	P.x = 600;	P.y = 500;
	pOut->DrawAssign(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "y = 8", false);
	...
	P.x = 100;	P.y = 100;
	pOut->DrawCondtionalStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "x > 5", true);
	P.x = 300;	P.y = 300;
	pOut->DrawCondtionalStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "y < 6", false);
	P.x = 600;	P.y = 300;
	pOut->DrawCondtionalStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "x <= 7", true);
	P.x = 600;	P.y = 500;
	pOut->DrawCondtionalStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "y => 8", false);
	pIn->GetPointClicked(P);	//Wait for any click
	pOut->ClearDrawArea();
	...
	P.x = 100;	P.y = 100;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "read x", true);
	P.x = 300;	P.y = 300;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "read y", false);
	P.x = 600;	P.y = 300;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "read z", true);
	P.x = 600;	P.y = 500;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "read w", false);
	pIn->GetPointClicked(P);	//Wait for any click
	pOut->ClearDrawArea();
	...
	P.x = 100;	P.y = 100;
	pOut->DrawWriteStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Read x", true);
	P.x = 300;	P.y = 300;
	pOut->DrawWriteStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Read y", false);
	P.x = 600;	P.y = 300;
	pOut->DrawWriteStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Read z", true);
	P.x = 600;	P.y = 500;
	pOut->DrawWriteStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Read w", false);

	pIn->GetPointClicked(P);	//Wait for any click
	pOut->ClearDrawArea();
	 
	P.x = 100;	P.y = 100;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Write x", false);
	P.x = 300;	P.y = 300;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Write y", true);
	P.x = 600;	P.y = 300;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Write z", false);
	P.x = 600;	P.y = 500;
	pOut->DrawReadStat(P, UI.ASSGN_WDTH, UI.ASSGN_HI, "Write w", true);
	pIn->GetPointClicked(P);	//Wait for any click
	pOut->ClearDrawArea();
